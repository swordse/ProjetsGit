...
extension AllWordsView {
    ...
    @MainActor final class AllWordsViewModel: ObservableObject {
        ...
        private func updateWordFav(words: [Word]) -> [Word] {
        ...
        private func setNavButton(numberOfWords: Int, wordState: WordState?)  {
